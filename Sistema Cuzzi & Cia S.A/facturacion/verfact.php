...
<table cellpadding="2" cellspacing="0" class="KT_tngtable">
  <tr>
    ...
    <td colspan="3"><strong><?php echo $cliente->Fields('idfact'); ?></strong></td>
  </tr>
  <tr>
    <td class="KT_th">CLIENTE:</td>
    <td colspan="2"><?php echo $cliente->Fields('cliente'); ?></td>
	<td class="KT_th">RUC:</td>
	<td colspan="3"><?php echo $cliente->Fields('ruc'); ?><strong></strong></td>
  </tr>
  <tr>
    <td class="KT_th">DIRECCION:</td>
    <td colspan="2"><?php echo $cliente->Fields('direccion'); ?></td>
    <td class="KT_th">FECHA:</td>
    <td colspan="3"><?php echo $cliente->Fields('fecha'); ?></td>
  </tr>
  <tr>
    <td class="KT_th">PEDIDO:</td>
    <td colspan="2"><?php echo $cliente->Fields('pedido'); ?></td>
    <td class="KT_th">G. REMISON:</td>
    <td colspan="3"><?php echo $cliente->Fields('gremi'); ?></td>
  </tr>
...
?>
    <tr>
      ...
      <td align="right"><a href="actufact.php?iddet=<?php echo $factura->Fields('iddetfact');?>&idfac=<?php echo $idfact;?>" target="mainFrame">modificar</a></td>
      <td align="right"><a href="../elimina.php?tabla=detallefact&idtabla=iddetfact&goto=facturacion/verfact.php&id=<?php echo $factura->Fields('iddetfact');?>&idfac=<?php echo $idfact;?>">eliminar</a></td>
    </tr>
    <?php
    $factura->MoveNext(); 
  }
?>
  ...
  <tr>
    <td colspan="4" align="right"><a href="detfact.php?idfac=<?php echo $idfact;?>&mone=<?php echo $mone;?>" target="mainFrame">Completar Factura</a></td>
    <td colspan="3" align="right"><a href="../fpdf/imprimir_factura.php?idfac=<?php echo $idfact;?>" target="mainFrame">Imprimir Factura</a></td>
  </tr>
</table>
</body>
</html>
