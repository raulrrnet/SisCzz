...
$query_facturas = "SELECT   f.idfact,   f.idcliente,   f.fecha,   f.gremi,   d.idorden,   d.cantidad,   d.descripcion,   d.und FROM factura f,   detallefact d WHERE f.idfact = d.idfact AND  estado <> 'anulada' AND  {$NXTFilter__facturas} ORDER BY {$NXTSort__facturas} ";
