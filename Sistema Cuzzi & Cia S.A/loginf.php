...
if (isset($_POST["user"])) {
  ...
  $KT_redirectLoginSuccess = "interfaces/facturacion/";
  ...
  $KT_rsUser_Source .= " FROM usuarios WHERE usuario=" . GetSQLValueString($KT_valUsername, "text") . " AND password=" . GetSQLValueString($_POST['pass'], "text"). " AND (cargo='facturacion' OR cargo='admin' OR cargo='gerencia')";
...
<tr>
<td class="form_validation_field_error_error_message"><?php echo $msg?></td>
</tr>
<tr>
<td align="center"><form ACTION="<?php echo $KT_LoginAction?>" method="POST" name="frmlogin" id="form1">
  ...
  <a href="login.php?usu=usuariof">Cambiar Password</a>
</form></td>
</tr>
</table>
</body>
