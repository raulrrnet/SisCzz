...
<body>
<form action="resulingre2.php" method="post" name="frm_salidas" id="frm_salidas">
...
$materiales->MoveFirst();
 ?>tipoconsumo_reload();
    ...
    <tr>
      ...
      <td>
        <input name="fecha" id="fecha" wdg:mondayfirst="false" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="false" wdg:restricttomask="no" />         
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
