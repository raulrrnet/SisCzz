...
<tr valign="top">
<td><form action="ordconsu.php" method="post" name="frm_salidas" target="idiframe" id="form1">
...
<td><iframe  name="idiframe" id="idiframe" width="700" height="500" frameborder="0" src="ordconsu.php">
	</iframe></td>
</tr>
</table>
</body>
