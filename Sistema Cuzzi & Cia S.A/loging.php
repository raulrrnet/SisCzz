...
if (isset($_POST["user"])) {
  ...
  $KT_rsUser_Source .= " FROM usuarios WHERE usuario=" . GetSQLValueString($KT_valUsername, "text") . " AND password=" . GetSQLValueString($_POST['pass'], "text"). " AND (cargo='gerencia' OR cargo='admin')";
...
<td align="center"><form ACTION="<?php echo $KT_LoginAction?>" method="POST" name="frmlogin" id="form1">
  ...
  <a href="login.php?usu=usuariog">Cambiar Password</a>
</form></td>
</tr>
</table>
</body>
