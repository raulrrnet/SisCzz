...
if (isset($_POST["user"])) {
  ...
  $KT_redirectLoginSuccess = "interfaces/operativos/";
  ...
  $KT_rsUser_Source .= " FROM usuarios WHERE usuario=" . GetSQLValueString($KT_valUsername, "text") . " AND password=" . GetSQLValueString($_POST['pass'], "text"). " AND (cargo='costos' OR cargo='admin' OR cargo='gerencia')";
...
<td align="center"><form ACTION="<?php echo $KT_LoginAction?>" method="POST" name="frmlogin" id="form1">
  ...
  <a href="login.php?usu=usuarioc">Cambiar Password</a>
</form></td>
</tr>
</table>
</body>
