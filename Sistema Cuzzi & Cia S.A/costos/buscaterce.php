...
<table width="100%" height="0" border="0" cellpadding="0">
  <tr valign="top">
    <td><form action="resulterce.php" method="get" name="frm_salidas" target="idiframe" id="form1">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    ...
    <tr>
      ...
      <td>
        <input name="fecha" id="fecha" value="" wdg:mondayfirst="false" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="false" wdg:restricttomask="no" />      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
	  <td>&nbsp;</td>
    ...
    <td><iframe  name="idiframe" id="idiframe" width="600" height="250" src="resulterce.php">
	</iframe></td>
  </tr>
</table>
</body>
