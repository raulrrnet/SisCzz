...
// begin Recordset
$query_consumos = "SELECT * FROM v_terceros WHERE fecha BETWEEN '$fecini' and '$fecfin' ORDER BY fecha";
...
?>
    <tr>
      ...
      <td>Trabajos de Ter.</td>
      <td><?php echo $consumos->Fields('descripcion'); ?></td>
      <td>o<?php echo $consumos->Fields('idorden'); ?></td>
      <td><?php echo $consumos->Fields('cantidad'); ?></td>
      <td><?php echo $consumos->Fields('valorus'); ?></td>
      <td><?php echo $consumos->Fields('valorud'); ?></td>
    </tr>
    <?php
    $consumos->MoveNext(); 
  }
