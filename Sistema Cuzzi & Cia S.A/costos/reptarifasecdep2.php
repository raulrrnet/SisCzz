...
// begin Recordset
$query_seccion = "SELECT * FROM seccion where idseccion<>0 ORDER BY seccion limit 5";
...
<p align="center"><a href="reptarifasecdep2x.php?fecha=<? echo $fecha; ?>">SIGUIENTE</a></p>
</body>
</html>
<?php
$seccion->Close();
