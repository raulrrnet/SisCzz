...
<form action="<?php echo $editFormAction; ?>" name="form2" method="POST" id="form1">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    <tr>
      <td colspan="2" class="KT_th">Ingrese Operaci&oacute;n </td>
    </tr>
    <tr>
      <td class="KT_th">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td class="KT_th"><label for="proveedor">Operaci&oacute;n:</label></td>
      <td><input type="text" name="operacion" id="operacion" size="32" /></td>
    </tr>
    <tr class="KT_buttons">
