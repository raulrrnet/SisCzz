...
// begin Recordset
$query_operario = "SELECT * FROM operario ORDER BY nombre ASC";
...
<tr valign="top">
<td><form action="tiempoope.php" method="post" name="frm_salidas" target="idiframe" id="form1">
  <table border="0" class="KT_tngtable">
    <tr>
      <td colspan="2">Informes por Operario </td>
    </tr>
...
<td><iframe  name="idiframe" id="idiframe" width="650" height="350" frameborder="0" src="tiempoope.php">
	</iframe></td>
</tr>
</table>
