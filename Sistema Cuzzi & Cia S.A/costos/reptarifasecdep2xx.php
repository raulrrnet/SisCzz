...
// begin Recordset
$query_seccion = "SELECT * FROM seccion where idseccion<>0 and  seccion > 'Diseño / Preprensa' or idseccion=20 ORDER BY seccion limit 5";
...
<p align="center"><a href="reptarifasecdep2xxx.php?fecha=<? echo $fecha; ?>">SIGUIENTE</a></p>
</body>
</html>
<?php
$seccion->Close();
