...
$mes = date("m",$fecfecha);
// begin Recordset
$sql = sprintf("SELECT * From costotros WHERE date_part('year',mes)=$anio ORDER BY mes");
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="KT_tngtable">
  <tr>
    <td align="center"><form name="form1" method="post" action="manteotros.php">
  ...
  <tr>
    <td><table cellpadding="2" cellspacing="0" class="KT_tngtable">
      <tr>
        <td colspan="4" class="KT_th"><span class="Estilo2"><strong>COSTOS OTROS</strong></span></td>
        </tr>
      <tr>
...
?>
      <tr>
        ...
        <td>&nbsp;</td>
        <td><a href="elimina.php?tabla=costotros&idtabla=idcostotros&goto=manteotros.php&id=<?php echo $exsql->Fields('idcostotros');?>">ELIMINAR</a></td>
      </tr>
      <?php
