...
$mes = date("m",$fecha);
$year = date("Y",$fecha);
$query_valida = "SELECT * FROM costotros WHERE date_part('month',mes)='$mes' and date_part('year',mes)=$year";
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form2" id="form1">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    <tr>
      <td colspan="2" class="KT_th">Costo Otros</td>
    </tr>
    <tr>
...
<a href="manteotros.php">VER COSTO OTROS</a></body>
</html>