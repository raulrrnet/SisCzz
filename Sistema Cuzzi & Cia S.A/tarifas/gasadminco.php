...
$mes = date("m",$fecha);
$year = date("Y",$fecha);
$query_valida = "SELECT * FROM gastoadmincomer WHERE date_part('month',fecha)='$mes' and date_part('year',fecha)=$year";
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form2" id="form1">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    <tr>
      <td colspan="2" class="KT_th">Gastos Administrativos y Comer.</td>
    </tr>
    <tr>
...
<a href="mantegadmincomer.php">Ver Gastos Admin. y Comerciales</a>
</body>
</html>