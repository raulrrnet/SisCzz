...
include('adodb/adodb.inc.php');
	$cnx_cuzzicia = ADONewConnection('postgres8'); # eg 'mysql' o 'postgres'
	//$db->debug = true;
	$cnx_cuzzicia->Connect(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_NAME);
$cone=new conexion(DB_SERVER,DB_NAME,DB_USERNAME,DB_PASSWORD);
$con=$cone->Conexion("");
$tiempo_inicio = microtime(true);
// begin Recordset
$bdata=$cone->BorrarData();
// begin Recordset
...
$Insert=$cone->insertFecReporte(1,$fecha);
...
$mes12=date('m',strtotime($exmes->Fields('mes12')));
$mes11=date('m',strtotime($exmes->Fields('mes11')));
$mes10=date('m',strtotime($exmes->Fields('mes10')));
$mes9=date('m',strtotime($exmes->Fields('mes9')));
$mes8=date('m',strtotime($exmes->Fields('mes8')));
$mes7=date('m',strtotime($exmes->Fields('mes7')));
$mes6=date('m',strtotime($exmes->Fields('mes6')));
$mes5=date('m',strtotime($exmes->Fields('mes5')));
$mes4=date('m',strtotime($exmes->Fields('mes4')));
$mes3=date('m',strtotime($exmes->Fields('mes3')));
$mes2=date('m',strtotime($exmes->Fields('mes2')));
$mes1=date('m',strtotime($exmes->Fields('mes1')));
$mes=date('m',strtotime($exmes->Fields('mes')));
$an12=date('Y',strtotime($exmes->Fields('mes12')));
$an11=date('Y',strtotime($exmes->Fields('mes11')));
$an10=date('Y',strtotime($exmes->Fields('mes10')));
$an9=date('Y',strtotime($exmes->Fields('mes9')));
$an8=date('Y',strtotime($exmes->Fields('mes8')));
$an7=date('Y',strtotime($exmes->Fields('mes7')));
$an6=date('Y',strtotime($exmes->Fields('mes6')));
$an5=date('Y',strtotime($exmes->Fields('mes5')));
$an4=date('Y',strtotime($exmes->Fields('mes4')));
$an3=date('Y',strtotime($exmes->Fields('mes3')));
$an2=date('Y',strtotime($exmes->Fields('mes2')));
$an1=date('Y',strtotime($exmes->Fields('mes1')));
$an=date('Y',strtotime($exmes->Fields('mes')));
$fecha12=date('Y/m/d',strtotime($exmes->Fields('mes12')));
$fecha11=date('Y/m/d',strtotime($exmes->Fields('mes11')));
$fecha10=date('Y/m/d',strtotime($exmes->Fields('mes10')));
$fecha9=date('Y/m/d',strtotime($exmes->Fields('mes9')));
$fecha8=date('Y/m/d',strtotime($exmes->Fields('mes8')));
$fecha7=date('Y/m/d',strtotime($exmes->Fields('mes7')));
$fecha6=date('Y/m/d',strtotime($exmes->Fields('mes6')));
$fecha5=date('Y/m/d',strtotime($exmes->Fields('mes5')));
$fecha4=date('Y/m/d',strtotime($exmes->Fields('mes4')));
$fecha3=date('Y/m/d',strtotime($exmes->Fields('mes3')));
$fecha2=date('Y/m/d',strtotime($exmes->Fields('mes2')));
$fecha1=date('Y/m/d',strtotime($exmes->Fields('mes1')));
$fechan=date('Y/m/d',strtotime($exmes->Fields('mes')));
?>
...
<body>
<form action="reptarifasecdep2.php" method="post">
...
//consultas para calculo electricidad 13 meses
		$q_totsec12 = sprintf("SELECT sum(tiempo*potencia) as tiempo FROM v_informes WHERE iddestino = 1  and date_part('year',fecha)=$an12 and date_part('month',fecha)=$mes12");
...
//generales planta
		$q_secti12 = sprintf("SELECT sum(tiempo) as tiempo FROM v_informes WHERE iddestino = 1 and date_part('month',fecha)=$mes12 and date_part('year',fecha)=$an12");
...
<table align="center" cellpadding="2" cellspacing="0" class="KT_tngtable">
  <?php
	...
	$q_opesec12 = sprintf("SELECT idoperario FROM v_informes WHERE (idseccion = $idsec or idseccion=0) and date_part('month',fecha)=$mes12 and date_part('year',fecha)=$an12 GROUP BY idoperario ORDER BY idoperario");
	...
	$tRows_operasec = $operasec12->RecordCount();
		...
		$q_asigsec12 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		$q_tiopesin12 = sprintf("SELECT sum(tiempo) as tiempo FROM v_informes WHERE (iddestino = 5 or iddestino = 6 or iddestino = 7 or iddestino = 8) and date_part('month',fecha)=$mes12 and date_part('year',fecha)=$an12 and idoperario = $idope");
		...
		//electricidad
		$q_facsec12 = sprintf("SELECT sum(tiempo*potencia) as tiempo FROM v_informes WHERE (iddestino = 1) and idseccion = $idsec and date_part('month',fecha)=$mes12 and date_part('year',fecha)=$an12");
		...
		//generales planta
		$q_cosgplan12 = sprintf("SELECT sum(costototal) as costotal FROM costogp WHERE date_part('month',mes)=$mes12 and date_part('year',mes)=$an12 and idseccion=$idsec");
		...
		$q_facgpsec12 = sprintf("SELECT sum(tiempo) as tiempo FROM v_informes WHERE iddestino = 1 and idseccion = $idsec and date_part('month',fecha)=$mes12 and date_part('year',fecha)=$an12");
		...
		{$totgenplan12[] = $excosgplan12->Fields('costotal');}
		//otros Gp
		$q_cosotros12 = sprintf("SELECT sum(costototal) as costotal FROM costotros WHERE idsec=$idsec and date_part('month',mes)=$mes12 and date_part('year',mes)=$an12");
		$excosotros12 = $cnx_cuzzicia->SelectLimit($q_cosotros12) or die($cnx_cuzzicia->ErrorMsg());
		$tototros12 = $excosotros12->Fields('costotal');
		$tototros12t[] = $excosotros12->Fields('costotal');
	...
	$tRows_operasec = $operasec11->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec11 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan11[] = $excosgplan11->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec10->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec10 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan10[] = $excosgplan10->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec9->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec9 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan9[] = $excosgplan9->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec8->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec8 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan8[] = $excosgplan8->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec7->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec7 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan7[] = $excosgplan7->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec6->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec6 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan6[] = $excosgplan6->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec5->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec5 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan5[] = $excosgplan5->Fields('costotal');}
		//otros Gp
...
//---------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec4->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec4 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan4[] = $excosgplan4->Fields('costotal');}
		//otros Gp
...
//--------------------------------------------------------------------------------- 
	...
	$tRows_operasec = $operasec3->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec3 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan3[] = $excosgplan3->Fields('costotal');}
		//otros Gp
...
//-----------------------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec2->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec2 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan2[] = $excosgplan2->Fields('costotal');}
		//otros Gp
...
//-----------------------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec1->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec1 = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan1[] = $excosgplan1->Fields('costotal');}
		//otros Gp
...
//--------------------------------------------------------------------------------------------
	...
	$tRows_operasec = $operasec->RecordCount();
		...
		// consulta asignacion operarios
		$q_asigsec = sprintf("SELECT porcentaje/100 as porcent FROM asignacion a WHERE idseccion=$idsec and idoperario = $idope");
		...
		{$totgenplan[] = $excosgplan->Fields('costotal');}
		//otros Gp
...
?>
  ...
  <tr>
	...
	$Insert=$cone->insertReporte($n,$n1,$n2,$n3,$n4,$n5,$n6,$n7,$n8,$n9,$n10,$n11,$n12);
	?>
  </tr>
  <tr>
...
?>
  ...
  <tr>
    ...
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an12."/".$mes12."/01' BETWEEN vig_inicio and vig_fin");
	$tf = $q->Fields('vsoles');$n = $q->Fields('vsoles');	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an11."/".$mes11."/01' BETWEEN vig_inicio and vig_fin");
	$tf = $q->Fields('vsoles');$n1 = $q->Fields('vsoles'); echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an10."/".$mes10."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n2 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an9."/".$mes9."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n3 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an8."/".$mes8."/01' BETWEEN vig_inicio and vig_fin");
	$tf = $q->Fields('vsoles');$n4 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an7."/".$mes7."/01' BETWEEN vig_inicio and vig_fin");
	$tf = $q->Fields('vsoles');$n5 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an6."/".$mes6."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n6 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an5."/".$mes5."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n7 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an4."/".$mes4."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n8 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php $q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an3."/".$mes3."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n9 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php 
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an2."/".$mes2."/01' BETWEEN vig_inicio and vig_fin");
	$tf = $q->Fields('vsoles');$n10 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php $q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec and '".$an1."/".$mes1."/01' BETWEEN vig_inicio and vig_fin");$tf = $q->Fields('vsoles');$n11 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <td align="right"><?php
	$q=$cnx_cuzzicia->Execute("select * from v_tarifas where  idseccion = $idsec 
	and '".$an."/".$mes."/01' BETWEEN vig_inicio and vig_fin");
	 $tf = $q->Fields('vsoles');$n12 = $q->Fields('vsoles');
	echo number_format($tf,2);?>
    </td>
    <?php
    $Insert=$cone->insertReporte($n,$n1,$n2,$n3,$n4,$n5,$n6,$n7,$n8,$n9,$n10,$n11,$n12);
