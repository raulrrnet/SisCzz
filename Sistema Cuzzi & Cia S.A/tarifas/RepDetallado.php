...
include('adodb/adodb.inc.php');
	...
	$rsSeccion->MoveFirst();
	$rsReporte = $db->Execute("select * from reportefinal");
	$rsReporte->MoveFirst();
...
?>
  ...
  <tr>
	...
	$tRow12+=$rsReporte->Fields(13);?></td>
    <td align="right"><?php echo number_format($tFila13,2);?></td>
  </tr>
    <?php if ($rsSeccion->Fields('idseccion')<>20){ 
...
<!--////////////////////////////////aqui el resumen del año//////////////////////////////////////-->
  ...
  <tr>
    ...
    <td class="KT_th">Total: Generales Planta</td>
    <td align="right"><?php echo number_format($tCelda104-$rsmo->Fields(1)-$rsmcs->Fields(1)-$rsmss->Fields(1)-$rsi->Fields(1)-$rse->Fields(1)-$rsd->Fields(1)-$rss->Fields(1)-$rsm->Fields(1)-$rso->Fields(1),2);?></td>
    <td align="right"><?php echo number_format($tCelda105-$rsmo->Fields(2)-$rsmcs->Fields(2)-$rsmss->Fields(2)-$rsi->Fields(2)-$rse->Fields(2)-$rsd->Fields(2)-$rss->Fields(2)-$rsm->Fields(2)-$rso->Fields(2),2);?></td>
    <td align="right"><?php echo number_format($tCelda106-$rsmo->Fields(3)-$rsmcs->Fields(3)-$rsmss->Fields(3)-$rsi->Fields(3)-$rse->Fields(3)-$rsd->Fields(3)-$rss->Fields(3)-$rsm->Fields(3)-$rso->Fields(3),2);?></td>
    <td align="right"><?php echo number_format($tCelda107-$rsmo->Fields(4)-$rsmcs->Fields(4)-$rsmss->Fields(4)-$rsi->Fields(4)-$rse->Fields(4)-$rsd->Fields(4)-$rss->Fields(4)-$rsm->Fields(4)-$rso->Fields(4),2);?></td>
    <td align="right"><?php echo number_format($tCelda108-$rsmo->Fields(5)-$rsmcs->Fields(5)-$rsmss->Fields(5)-$rsi->Fields(5)-$rse->Fields(5)-$rsd->Fields(5)-$rss->Fields(5)-$rsm->Fields(5)-$rso->Fields(5),2);?></td>
    <td align="right"><?php echo number_format($tCelda109-$rsmo->Fields(6)-$rsmcs->Fields(6)-$rsmss->Fields(6)-$rsi->Fields(6)-$rse->Fields(6)-$rsd->Fields(6)-$rss->Fields(6)-$rsm->Fields(6)-$rso->Fields(6),2);?></td>
    <td align="right"><?php echo number_format($tCelda110-$rsmo->Fields(7)-$rsmcs->Fields(7)-$rsmss->Fields(7)-$rsi->Fields(7)-$rse->Fields(7)-$rsd->Fields(7)-$rss->Fields(7)-$rsm->Fields(7)-$rso->Fields(7),2);?></td>
    <td align="right"><?php echo number_format($tCelda111-$rsmo->Fields(8)-$rsmcs->Fields(8)-$rsmss->Fields(8)-$rsi->Fields(8)-$rse->Fields(8)-$rsd->Fields(8)-$rss->Fields(8)-$rsm->Fields(8)-$rso->Fields(8),2);?></td>
    <td align="right"><?php echo number_format($tCelda112-$rsmo->Fields(9)-$rsmcs->Fields(9)-$rsmss->Fields(9)-$rsi->Fields(9)-$rse->Fields(9)-$rsd->Fields(9)-$rss->Fields(9)-$rsm->Fields(9)-$rso->Fields(9),2);?></td>
    <td align="right"><?php echo number_format($tCelda113-$rsmo->Fields(10)-$rsmcs->Fields(10)-$rsmss->Fields(10)-$rsi->Fields(10)-$rse->Fields(10)-$rsd->Fields(10)-$rss->Fields(10)-$rsm->Fields(10)-$rso->Fields(10),2);?></td>
    <td align="right"><?php echo number_format($tCelda114-$rsmo->Fields(11)-$rsmcs->Fields(11)-$rsmss->Fields(11)-$rsi->Fields(11)-$rse->Fields(11)-$rsd->Fields(11)-$rss->Fields(11)-$rsm->Fields(11)-$rso->Fields(11),2);?></td>
    <td align="right"><?php echo number_format($tCelda115-$rsmo->Fields(12)-$rsmcs->Fields(12)-$rsmss->Fields(12)-$rsi->Fields(12)-$rse->Fields(12)-$rsd->Fields(12)-$rss->Fields(12)-$rsm->Fields(12)-$rso->Fields(12),2);?></td>
    <td align="right"><?php echo number_format($tCelda116-$rsmo->Fields(13)-$rsmcs->Fields(13)-$rsmss->Fields(13)-$rsi->Fields(13)-$rse->Fields(13)-$rsd->Fields(13)-$rss->Fields(13)-$rsm->Fields(13)-$rso->Fields(13),2);?></td>
    <td align="right"><?php echo number_format(($tCelda105+$tCelda106+$tCelda107+$tCelda108+$tCelda109+$tCelda110+$tCelda111+$tCelda112+$tCelda113+$tCelda114+$tCelda115+$tCelda116-$rsmo->Fields(2)-$rsmcs->Fields(2)-$rsmss->Fields(2)-$rsi->Fields(2)-$rse->Fields(2)-$rsd->Fields(2)-$rss->Fields(2)-$rsm->Fields(2)-$rso->Fields(2)-$rsmo->Fields(3)-$rsmcs->Fields(3)-$rsmss->Fields(3)-$rsi->Fields(3)-$rse->Fields(3)-$rsd->Fields(3)-$rss->Fields(3)-$rsm->Fields(3)-$rso->Fields(3)-$rsmo->Fields(4)-$rsmcs->Fields(4)-$rsmss->Fields(4)-$rsi->Fields(4)-$rse->Fields(4)-$rsd->Fields(4)-$rss->Fields(4)-$rsm->Fields(4)-$rso->Fields(4)-$rsmo->Fields(5)-$rsmcs->Fields(5)-$rsmss->Fields(5)-$rsi->Fields(5)-$rse->Fields(5)-$rsd->Fields(5)-$rss->Fields(5)-$rsm->Fields(5)-$rso->Fields(5)-$rsmo->Fields(6)-$rsmcs->Fields(6)-$rsmss->Fields(6)-$rsi->Fields(6)-$rse->Fields(6)-$rsd->Fields(6)-$rss->Fields(6)-$rsm->Fields(6)-$rso->Fields(6)-$rsmo->Fields(7)-$rsmcs->Fields(7)-$rsmss->Fields(7)-$rsi->Fields(7)-$rse->Fields(7)-$rsd->Fields(7)-$rss->Fields(7)-$rsm->Fields(7)-$rso->Fields(7)-$rsmo->Fields(8)-$rsmcs->Fields(8)-$rsmss->Fields(8)-$rsi->Fields(8)-$rse->Fields(8)-$rsd->Fields(8)-$rss->Fields(8)-$rsm->Fields(8)-$rso->Fields(8)-$rsmo->Fields(9)-$rsmcs->Fields(9)-$rsmss->Fields(9)-$rsi->Fields(9)-$rse->Fields(9)-$rsd->Fields(9)-$rss->Fields(9)-$rsm->Fields(9)-$rso->Fields(9)-$rsmo->Fields(10)-$rsmcs->Fields(10)-$rsmss->Fields(10)-$rsi->Fields(10)-$rse->Fields(10)-$rsd->Fields(10)-$rss->Fields(10)-$rsm->Fields(10)-$rso->Fields(10)-$rsmo->Fields(11)-$rsmcs->Fields(11)-$rsmss->Fields(11)-$rsi->Fields(11)-$rse->Fields(11)-$rsd->Fields(11)-$rss->Fields(11)-$rsm->Fields(11)-$rso->Fields(11)-$rsmo->Fields(12)-$rsmcs->Fields(12)-$rsmss->Fields(12)-$rsi->Fields(12)-$rse->Fields(12)-$rsd->Fields(12)-$rss->Fields(12)-$rsm->Fields(12)-$rso->Fields(12)-$rsmo->Fields(13)-$rsmcs->Fields(13)-$rsmss->Fields(13)-$rsi->Fields(13)-$rse->Fields(13)-$rsd->Fields(13)-$rss->Fields(13)-$rsm->Fields(13)-$rso->Fields(13)),2);?></td>   
  </tr>
  <tr>
  ...
  <tr>
    <td class="KT_th">Total : Costo x hora </td>
    
    <td align="right"><?php echo number_format($tCelda130/$tCelda143,2);?></td>
    <td align="right"><?php echo number_format($tCelda131/$tCelda144,2);?></td>
    <td align="right"><?php echo number_format($tCelda132/$tCelda145,2);?></td>
    <td align="right"><?php echo number_format($tCelda133/$tCelda146,2);?></td>
    <td align="right"><?php echo number_format($tCelda134/$tCelda147,2);?></td>
    <td align="right"><?php echo number_format($tCelda135/$tCelda148,2);?></td>
    <td align="right"><?php echo number_format($tCelda136/$tCelda149,2);?></td>
    <td align="right"><?php echo number_format($tCelda137/$tCelda150,2);?></td>
    <td align="right"><?php echo number_format($tCelda138/$tCelda151,2);?></td>
    <td align="right"><?php echo number_format($tCelda139/$tCelda152,2);?></td>
    <td align="right"><?php echo number_format($tCelda140/$tCelda153,2);?></td>
    <td align="right"><?php echo number_format($tCelda141/$tCelda154,2);?></td>
	<td align="right"><?php echo number_format($tCelda142/$tCelda155,2);?></td>
    <td align="right"><?php echo number_format($ta/$to,2);?></td>
  </tr>
  <tr>
  	<td class="KT_th">Total : Tarifa </td>
    
    <td align="right"><?php echo number_format($tCelda169,2);?></td>
    <td align="right"><?php echo number_format($tCelda170,2);?></td>
    <td align="right"><?php echo number_format($tCelda171,2);?></td>
    <td align="right"><?php echo number_format($tCelda172,2);?></td>
    <td align="right"><?php echo number_format($tCelda173,2);?></td>
    <td align="right"><?php echo number_format($tCelda174,2);?></td>
    <td align="right"><?php echo number_format($tCelda175,2);?></td>
    <td align="right"><?php echo number_format($tCelda176,2);?></td>
    <td align="right"><?php echo number_format($tCelda177,2);?></td>
    <td align="right"><?php echo number_format($tCelda178,2);?></td>
    <td align="right"><?php echo number_format($tCelda179,2);?></td>
    <td align="right"><?php echo number_format($tCelda180,2);?></td>
	<td align="right"><?php echo number_format($tCelda181,2);?></td>
    <td align="right"><?php echo number_format(($tCelda170+$tCelda171+$tCelda172+$tCelda173+$tCelda174+$tCelda175+$tCelda176+$tCelda177+$tCelda178+$tCelda179+$tCelda180+$tCelda181),2);?></td>
  </tr>
</table>
</body>
</html>
