...
$year = date("Y",$fecha);
$opera = $_POST['idope'];
$query_valida = "SELECT * FROM costoperario WHERE date_part('month',mes)='$mes' and idoperario=$opera and date_part('year',mes)=$year";
...
$totalRows_valida = $valida->RecordCount();
  ...
  $insertSQL = sprintf("INSERT INTO costoperario (idoperario, mes, costototal) VALUES (%s, %s, %s)",
...
<a href="mantecostope.php">VER COSTOS OPERARIO</a>
</body>
</html>
<?php
$operario->Close();
