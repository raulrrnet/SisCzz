...
$mes = date("m",$fecfecha);
// begin Recordset
$sql = sprintf("SELECT * From costoelec WHERE date_part('year',mes)=$anio ORDER BY mes");
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="KT_tngtable">
  <tr>
    <td align="center"><form name="form1" method="post" action="manteelec.php">
  ...
  <tr>
    <td><table cellpadding="2" cellspacing="0" class="KT_tngtable">
      <tr>
        <td colspan="4" class="KT_th"><span class="Estilo2"><strong>COSTOS ELECTRICIDAD</strong></span></td>
        </tr>
      <tr>
...
?>
      <tr>
        <td><?php echo $exsql->Fields('mes'); ?></td>
        <td align="right"><?php echo number_format($exsql->Fields('costototal'),2); ?></td>
        <td>&nbsp;</td>
        <td><a href="elimina.php?tabla=costoelec&idtabla=idcostoelec&goto=manteelec.php&id=<?php echo $exsql->Fields('idcostoelec');?>">ELIMINAR</a></td>
      </tr>
      <?php
