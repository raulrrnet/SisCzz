...
$mes = date("m",$fecfecha);
// begin Recordset
$sql = sprintf("SELECT * From costogp WHERE date_part('year',mes)=$anio ORDER BY mes");
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="KT_tngtable">
  <tr>
    <td align="center"><form name="form1" method="post" action="mantegp.php">
  ...
  <tr>
    <td><table cellpadding="2" cellspacing="0" class="KT_tngtable">
      <tr>
        <td colspan="4" class="KT_th"><span class="Estilo2"><strong>COSTOS GENERALES
              PLANTA</strong></span></td>
        </tr>
      <tr>
...
?>
      <tr>
        ...
        <td>&nbsp;</td>
        <td><a href="elimina.php?tabla=costogp&idtabla=idcostogp&goto=mantegp.php&id=<?php echo $exsql->Fields('idcostogp');?>">ELIMINAR</a></td>
      </tr>
      <?php
