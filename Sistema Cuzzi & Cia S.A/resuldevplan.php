...
?>
  <tr>
    ...
    <td><A HREF="devplan.php?<?php echo $MM_keepURL . (($MM_keepURL!="")?"&":"") . "idmovimiento=" . urlencode($cnsalidas->Fields('idmovimiento')) ?>&<?php echo $MM_keepURL . (($MM_keepURL!="")?"&":"") . "idmaterial=" . urlencode($cnsalidas->Fields('idmateriales')) ?>"><?php echo $cnsalidas->Fields('idmateriales'); ?></A></td>
