...
<table width="100%" height="0" border="0" cellpadding="0">
  <tr>
    <td><form action="compcant.php" method="post" name="frm_salidas" target="idiframe" id="form1">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    ...
    <tr>
      <td class="KT_th"><label for="fecha">Proveedor:</label>      </td>
      <td><select name="prov" id="prov">
          <?php
  while(!$proveedor->EOF){
?>
          <option value="<?php echo $proveedor->Fields('proveedor')?>"><?php echo $proveedor->Fields('proveedor')?></option>
          <?php
    $proveedor->MoveNext();
  }
  $proveedor->MoveFirst();
...
$materiales->MoveFirst();
 ?>tipo_reload();
    ...
    <td valign="top"><iframe  name="idiframe" id="idiframe" width="650" height="305" src="compcant.php">
	</iframe></td>
  </tr>
</table>
</body>
