...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO proveedor (proveedor) VALUES (%s)",
...
<form action="<?php echo $editFormAction; ?>" name="form2" method="POST" id="form1">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    <tr>
      <td colspan="2" class="KT_th">Ingrese Proveedor </td>
    </tr>
    <tr>
      <td class="KT_th">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td class="KT_th"><label for="proveedor">Proveedor:</label></td>
      <td><input type="text" name="proveedor" id="proveedor" /></td>
    </tr>
    <tr class="KT_buttons">
