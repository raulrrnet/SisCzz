...
<table>
  <tr><td valign="top">
<form action="compras.php" method="post" name="frm_salidas" target="idiframe" id="form1">
...
<td valign="top"><iframe name="idiframe" id="idiframe" width="505" height="100%" src="compras.php">
	</iframe></td>
</tr></table>
</body>
</html>
