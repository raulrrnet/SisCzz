...
// end Recordset
    ...
    $pdf->Ln(30);
	$pdf->Cell(15);
    $pdf->Cell(125,4,$factura->Fields('nombre'),0,0,'L',0);
    //DNI
	$pdf->Ln(4.5);
	$pdf->Cell(15);
	$pdf->Cell(125,4,$factura->Fields('dni'),0,0,'L',0);
    //ruc, pedidos, fecha formato...
	//direccion
	$pdf->Ln(4.5);
	$pdf->Cell(15);
	$pdf->Cell(125,4,$factura->Fields('direcbol'),0,0,'L',0);
    //ruc, pedidos, fecha formato...
	$pdf->Ln(4.5);
	$pdf->Cell(10);
	$pdf->Cell(35,4,$factura->Fields('pedido'),0,0,'L',0);
	$pdf->Cell(100,4,$fecha,0,0,'R',0);
	//guia remision
    $pdf->Ln(4.5);
	$pdf->Cell(50);
...
//	$pdf->Cell(-8);
	...
	$pdf->SetY(110);
	$pdf->Cell(30);
	$pdf->Cell(82,4,"Exonerado del IGV seg�n Ley N� 28086, Art. 19 Ley",0,0,'L',0);
	$pdf->Ln(5);
	$pdf->Cell(30);
	$pdf->Cell(82,4,"Democratizaci�n del Libro y de Fomento a la Lectura.",0,0,'L',0);
	}
