...
<title>Sistema Cuzzi - Modulo Operativos</title>
</head>

<frameset rows="99,*" cols="*" frameborder="no" border="0" framespacing="0">
  <frame src="../logistica/cabece.html" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="topFrame" />
  <frameset rows="*" cols="180,*" framespacing="0" frameborder="no" border="0">
    <frame src="../logistica/menusm.html" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" title="leftFrame" />
    <frame src="../logistica/conte.html" name="mainFrame" id="mainFrame" title="mainFrame" />
  </frameset>
</frameset>
<noframes><body>
</body>
