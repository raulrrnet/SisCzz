...
<tr valign="top">
<td><form action="ordconsu2.php" method="post" name="frm_salidas" target="idiframe" id="form1">
<table border="0" class="KT_tngtable">
  <tr>
    <td colspan="2">Consumos por Orden</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><input name="orden" id="orden" wdg:subtype="DynamicSearch" wdg:recordset="ordenes" wdg:type="widget" wdg:displayfield="idorden" wdg:norec="50" wdg:defaultoptiontext="no"></td>
    <td><input type="submit" name="Submit" value="Consultar"></td>
  </tr>
</table></form></td>
<td><iframe  name="idiframe" id="idiframe" width="700" height="500" frameborder="0" src="ordconsu2.php">
	</iframe></td>
</tr>
</table>
</body>
