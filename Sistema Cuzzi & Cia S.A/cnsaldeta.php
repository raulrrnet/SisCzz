...
<form action="detasal.php" method="post" name="frm_salidas" target="idiframe" id="form1">
 ...
 ?>tipoconsumo_reload();
    ...
    <tr class="KT_buttons">
      <td colspan="2">
        ...
        <input name="buscar" type="submit" id="buscar" onClick="MM_validateForm('fecha','','R');return document.MM_returnValue" value="Buscar" />      </td>
    </tr>
  </table>
</form>
<a href="matsaldos.php">TODOS LOS MATERIALES</a></td>
    <td valign="top"><iframe name="idiframe" id="idiframe" width="500" height="100%" src="detasal.php">
	</iframe></td>
</tr></table>
</body>
</html>
