...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frm_salidas")) {
	...
	$vuotross = $_POST['vuotross'];
	$vuotrosd = $_POST['vuotrosd'];
	...
	//actulaizar ingreso
	$upingreg = "UPDATE movimientos SET idmaterial=$material, idproveedor=$prov, motivo='$motivo', fecha='$fecha', referencia='$ref', cantidad=$cantsali, vusoles=$vusoles, vudolar=$vudolar, vuotross=$vuotross, vuotrosd=$vuotrosd, tipodoc=$tipodoc, serie=$serie, tipoope=$tipoope WHERE idmovimiento=$id";
...
<!--
function calculos(){
document.frm_ingresos.vusoles.value = ((+parseFloat(document.frm_ingresos.valorsoles.value)+parseFloat(document.frm_ingresos.votross.value)) / parseFloat(document.frm_ingresos.cantidad.value));
document.frm_ingresos.vudolar.value = ((+parseFloat(document.frm_ingresos.valordolar.value)+parseFloat(document.frm_ingresos.votrosd.value)) / parseFloat(document.frm_ingresos.cantidad.value));
document.frm_ingresos.vuotross.value = (parseFloat(document.frm_ingresos.votross.value) / parseFloat(document.frm_ingresos.cantidad.value));
document.frm_ingresos.vuotrosd.value = (parseFloat(document.frm_ingresos.votrosd.value) / parseFloat(document.frm_ingresos.cantidad.value));
}
//-->
</script>
...
?>
    ...
    <tr>
      ...
      <td><input name="serie" type="text" id="serie" value="<?php echo $actuliza->Fields('serie'); ?>" /></td>
    </tr>
    <tr>
...
$materiales->MoveFirst();
 ?>tipo_reload();
    ...
    <tr>
      <td class="KT_th">ValorSoles:
        <input name="vusoles" type="hidden" id="vusoles"></td>
      <td><input name="valorsoles" type="text" id="valorsoles" value="<?php echo ($actuliza->Fields('vusoles')-$actuliza->Fields('vuotross'))*$actuliza->Fields('cantidad'); ?>">
      <span class="Estilo1">      Ingresar</span></td>
    </tr>
    <tr>
      <td class="KT_th">ValorDolar:
      <input name="vudolar" type="hidden" id="vudolar"></td>
      <td><input name="valordolar" type="text" id="valordolar" value="<?php echo ($actuliza->Fields('vudolar')-$actuliza->Fields('vuotrosd'))*$actuliza->Fields('cantidad'); ?>"> 
        <span class="Estilo1">Ambos </span></td>
    </tr>
    <tr>
      <td class="KT_th">VOtrosSoles:
      <input name="vuotross" type="hidden" id="vuotross"></td>
      <td><input name="votross" type="text" id="votross" value="<?php echo $actuliza->Fields('vuotross')*$actuliza->Fields('cantidad'); ?>">
      <span class="Estilo1">      * </span></td>
    </tr>
    <tr>
      <td class="KT_th">VOtrosDolar:
      <input name="vuotrosd" type="hidden" id="vuotrosd"></td>
      <td><input name="votrosd" type="text" id="votrosd" value="<?php echo $actuliza->Fields('vuotrosd')*$actuliza->Fields('cantidad'); ?>">
      <span class="Estilo1">      * </span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr class="KT_buttons">
      <td colspan="2">
        ...
        <input type="submit" name="KT_Insert1" id="KT_Insert1" value="Actualizar" onClick="calculos()"/>      </td>
    </tr>
  </table>
