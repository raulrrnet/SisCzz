...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" target="_parent">
  <tr>
    <td>Fecha Liq.: 
      <input name="idord" type="hidden" id="idord" value="<?php echo $orden__consuor; ?>">
      <input name="fecliq" id="fecliq" value="<?php echo $datorden->Fields('fechaliqui'); ?>" wdg:mondayfirst="false" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="true" wdg:restricttomask="no" wdg:readonly="true"></td>
    <td>
      C. Producida: 
      <input name="cantprod" type="text" id="cantprod" value="<?php echo $datorden->Fields('cantprod'); ?>"></td>
    </tr>
  <tr>
    <td colspan="2">Observaciones:<br>
      <textarea name="obser" cols="40" id="obser"><?php echo $datorden->Fields('obserliqui'); ?></textarea>
      &nbsp;
      <input type="submit" name="button" id="button" value="Liquidar"></td>
    </tr>
...
<tr>
  <td class="KT_th">ADMINISTRATIVOS (60%):</td>
  <td align="right">&nbsp;</td>
  <td align="right">&nbsp;</td>
