...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_salidas")) {
	...
	$query_tingreso = "SELECT sum(cantsaldo) FROM vingresos WHERE idmateriales = '$material' and fecha <= '$fecha' and año = $ano;";
	$tingreso = $cnx_cuzzicia->Execute($query_tingreso) or die($cnx_cuzzicia->ErrorMsg());

	$query_ingresos = "SELECT * FROM vingresos WHERE idmateriales = '$material' and fecha <= '$fecha' and año = $ano ORDER BY fecha;";
